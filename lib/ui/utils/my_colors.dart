...
class AppColors {
  static const primaryColor = Color(0xFF1F4284);
  static const darkPrimaryColor = Color(0xFF1F4284);
  ...
  static Color redColor = Color(0xffBC3018);
  static Color blueColor = Color(0xff0973DD);
